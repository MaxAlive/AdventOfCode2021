...
for permu in permutations(data,2):
    snail_number = reduce_number(add_numbers(*permu))
    if int(get_magnitude(snail_number)) > highest_sum:
        highest_sum = int(get_magnitude(snail_number))
